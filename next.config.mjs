...
// Function to generate MDX layout
...
// Asynchronous function to get MDX configuration
async function getMDXConfig() {
...
export default async function nextConfig() {
  ...
  return {
    ...mdxConfig,
    output: 'export', // Configure Next.js to output static HTML
    images: {
